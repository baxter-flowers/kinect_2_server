...
class Kinect2Client(object):
    def __init__(self, ip, params_port=33410, skel_speech_port=33405, tts_port=33406, param_port=33410):
        ...
        self.skeleton = SkeletonSubscriber(self.context, 'skeleton', ip, skel_speech_port, param_port)
        self.speech = SpeechSubscriber(self.context, 'recognized_speech', ip, skel_speech_port, param_port)
